...
class MedicationIntegrationTest(TestCase):
    """Інтеграційні тести повного циклу роботи з медикаментами"""
    ...
    def test_full_medication_workflow(self, mock_db):
        """
        Сценарій:
        створення медикаменту → перегляд → оновлення → видалення
        """
...
class EquipmentIntegrationTest(TestCase):
    """Інтеграційні тести повного циклу роботи з обладнанням"""
    ...
    def test_full_equipment_workflow(self, mock_db, mock_mongo):
        """
        Сценарій:
        додавання обладнання → список → перегляд → оновлення → логічне видалення
        """
...
class StatisticsIntegrationTest(TestCase):
    """Інтеграційні тести аналітики та API"""
    ...
    def test_medication_statistics_api(self, mock_stats):
        """Тест інтеграції API статистики медикаментів"""
    ...
    def test_critical_medications_api(self, mock_critical):
        """Тест інтеграції API критичних медикаментів"""
