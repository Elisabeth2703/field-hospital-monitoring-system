...
def load_medications_data():
    ...
    # Перетворюємо дати в datetime, якщо є
...
def medication_forecast(months_ahead=3):
    ...
    # Перетворюємо у pandas.Series з datetime index
